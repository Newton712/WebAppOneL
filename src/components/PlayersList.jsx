              ...
              <tr key={p.id} className={idx % 2 === 0 ? 'bg-[#1e1e1e]' : 'bg-[#2a2a2a]'}>
                ...
                <td className="px-4 py-2 border-b border-gray-700 text-center">
                  {isEditing ? (
                    ...
                    p.Deckcolor1 && <img src={colorImages[p.Deckcolor1.toLowerCase()]} alt={p.Deckcolor1} className="w-5 h-5 inline-block rounded" />
                  )}
                </td>
                <td className="px-4 py-2 border-b border-gray-700 text-center">
                  {isEditing ? (
                    ...
                    p.Deckcolor2 && <img src={colorImages[p.Deckcolor2.toLowerCase()]} alt={p.Deckcolor2} className="w-5 h-5 inline-block rounded" />
                  )}
                </td>
                <td className="px-4 py-2 border-b border-gray-700 text-center">
                  {isEditing ? (
